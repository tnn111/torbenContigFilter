...
This sample module contains one small method that filters contigs.
    ...
    def run_torbenContigFilter(self, ctx, params):
        """
        ...
        #BEGIN run_torbenContigFilter

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_torbenContigFilter function. Params=' + pformat(params))
        ...
        #END run_torbenContigFilter

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_torbenContigFilter return value ' +
